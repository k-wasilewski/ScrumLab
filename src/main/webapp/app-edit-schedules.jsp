...
<body>
<%@ include file="HeaderAndMenuForLoggedUser.jsp" %>
        ...
        <div class="m-4 p-3 width-medium">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                ...
                <form action="/app/plan/edit" method="post">
                    <input type="hidden" name="id" value="${editedPlan.id}">
                    <div class="row border-bottom border-3 p-1 m-1">
                        <div class="col noPadding">
                            <h3 class="color-header text-uppercase">EDYCJA PLANU</h3>
                        </div>
                        <div class="col d-flex justify-content-end mb-2">
                            <button href="/app/plan/list" type="submit" class="btn btn-color rounded-0 pt-0 pb-0 pr-4 pl-4">Zapisz</button>
                        </div>
                    </div>
                    ...
                    <div class="schedules-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="name" class="form-control" value="${editedPlan.name}" id="planName">
                            </div>
                        </div>
                        <div class="form-group row">
