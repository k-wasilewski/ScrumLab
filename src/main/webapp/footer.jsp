...
<section class="last-info-section padding-small" id="contact">
    <div class="container">
        <div class="row">
            <div class="col">
                <h3 class="mb-4">Projekt ScrumLab w CodersLab</h3>
                <p>Nauka pracy zespołowej</p>
            </div>
            <div class="col pl-4 ml-4">
                <h3 class="mb-4">Autorzy</h3>
                <ul class="container">
                    <li>Kuba Wasilewski</li>
                    <li>Kuba Wziątka</li>
                    <li>Aleksander Machaj</li>
                    <li>Oskar Burdyna</li>
                </ul>
            </div>
            <div class="col">
                <h3 class="mb-4">...w trakcie budowy</h3>
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                        <button class="input-group-text btn-color border-0 rounded-0" type="submit" id="basic-addon2"><a
                                href="">Zapisz</a></button> <!-- newsletter link -->
                    </div>
                </div>
